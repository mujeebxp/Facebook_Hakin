...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" 😍Dope skin😍  "$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Shehan lahiru "$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [ovin🤗] [MR.S∆MAx] [MR.k -mek😍]"$i"  |"
...
echo $i"|"$me" 2"$i" |"$cy" FACEBOOK   FB BR1G4D3    "$i"|"$i"    |"$cy" A"$i" |"
echo $i"|"$me" 3"$i" |"$cy" FACEBOOK   FB iqbalz     "$i"|"$i"    |"$cy" C"$i" |"
echo $i"|"$me" 4"$i" |"$cy" FACEBOOK   FB MBF        "$i"|"$i"    |"$cy" E"$i" |"
echo $i"|"$me" 5"$i" |"$cy" FACEBRUTE N1ght420       "$i"|"$i"    |"$cy" B"$i" |"
echo $i"|"$me" 6"$i" |"$cy" DARK TOOL  FB ( root )   "$i"|"$i"    |"$cy" O"$i" |"
echo $i"────────────────────────────────"$i"    |"$cy" K"$i" |"
echo $i"|"$me" 7"$i" |"$cy" YAHOO CLONING FACEBOOK   "$i"|"$i"    ─────"
echo $i"|"$me" 8"$i" |"$cy" PROFILE GUARD FACEBOOK   "$i"|"$i"    |"$cy" T"$i" |"
echo $i"|"$me" 9"$i" |"$cy" REPORT FACEBOOK WORK     "$i"|"$i"    |"$cy" T"$i" |"
echo $i"|"$me"10"$i" |"$cy" AUTO REACTION FACEBOOK   "$i"|"$i"    |"$cy" O"$i" |"
echo $i"|"$me"11"$i" |"$cy" INFORMATION FACEBOOK     "$i"|"$i"    |"$cy" L"$i" |"
echo $i"|"$me"12"$i" |"$cy" BOT KOMEN FACEBOOK       "$i"|"$i"    |"$cy" 😀"$i" |"
echo $i"|"$me"13"$i" |"$cy" AUTOLIKE FACEBOOK        "$i"|"$i"    |"$cy" S"$i" |"
echo $i"────────────────────────────────"$i"    |"$cy" L"$i" |"
echo $i"|"$me"14"$i" |"$cy" HACKIN  FACEBOOK 1       "$i"|"$i"    |"$cy" S"$i" |"
echo $i"|"$me"15"$i" |"$cy" HACKIN  FACEBOOK 2       "$i"|"$i"    ─────"
echo $i"|"$me"16"$i" |"$cy" HACKIN  FACEBOOK 3       "$i"|"$i"    |"$cy" H"$i" |"
echo $i"|"$me"17"$i" |"$cy" HACKIN  FACEBOOK 4       "$i"|"$i"    |"$cy" E"$i" |"
echo $i"────────────────────────────────"$i"    |"$cy" H"$i" |"
