...
echo $i" |"$pu" THANKS TO :"$cy"~ [sd] [MR.Ovin-J😉] [..B]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%MR.S%] [k-MAk]"$i" |"
...
echo
echo $i"────────────────────────────────    ─────"
echo $i"|"$me" 1"$i" |"$cy"  FB Top  PHP        "$i"|"$i"    |"$cy" B"$i" |"
echo $i"|"$me" 2"$i" |"$cy" Tool FB BR1G4D3    "$i"|"$i"    |"$cy" E"$i" |"
echo $i"|"$me" 3"$i" |"$cy" BRUTEFORCE FB iqbalz     "$i"|"$i"    |"$cy" N"$i" |"
echo $i"|"$me" 4"$i" |"$cy" BRUTEFORCE FB MBF        "$i"|"$i"    |"$cy" G"$i" |"
echo $i"|"$me" 5"$i" |"$cy" Facebook N1ght420       "$i"|"$i"    |"$cy" K"$i" |"
...
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"worning"]"$me"======"$bi"["$i""Don't copy ""$bi"]"
echo $me"¦"
read -p"└──# " pil
